...
api_file = "/Users/davinchee/shoplane/backend/app/api/admin_coupons.py"
...
# Write admin_coupons.py
with open(api_file, "w") as f:
    f.write(content)
print("Created admin_coupons.py")

# Update main.py
main_file = "/Users/davinchee/shoplane/backend/app/main.py"
with open(main_file, "r") as f:
    main_content = f.read()

if "admin_coupons" not in main_content:
    # 1. Add import
...
app.include_router(
    ...
    main_content = main_content.replace(anchor, new_mount)
